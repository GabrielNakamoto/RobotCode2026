...
public abstract class ModuleIOTalonFX implements ModuleIO {
  ...
  protected VelocityTorqueCurrentFOC velocityTorqueRequest = new VelocityTorqueCurrentFOC(0.0);
	...
	protected MotionMagicTorqueCurrentFOC positionMagicTorqueRequest = new MotionMagicTorqueCurrentFOC(0.0);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.drivePosition = Meters.of(
				drivePosition.getValue().in(Radians) / constants.DriveMotorGearRatio);
  ...
  public void applyOutputs(ModuleIOOutputs outputs) {
    final double driveWheelVelocityMps = outputs.driveVelocity.in(MetersPerSecond) / DriveConstants.wheelRadius.in(Meters);
    ...
    turnMotor.setControl(switch (constants.SteerMotorClosedLoopOutput) {
      case Voltage -> DriveConstants.motionMagicSteerControl ?
      ...
      case TorqueCurrentFOC -> DriveConstants.motionMagicSteerControl ?
